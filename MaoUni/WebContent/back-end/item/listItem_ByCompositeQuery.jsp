...
<jsp:useBean id="listItem_ByCompositeQuery" scope="request" type="java.util.List<ItemVO>" /> <!-- 於EL此行可省略 -->
							...
							<tbody>	
								<c:forEach var="itemVO" items="${listItem_ByCompositeQuery}">
									<tr style="width: 70px;text-align: center;">
										...
										<c:if test="${itemVO.itemTypeId == '1'}"><td scope="col" class="itemTypeId" style="width: 90px;text-align: center;">毛孩食品</td></c:if>
										<c:if test="${itemVO.itemTypeId == '2'}"><td scope="col" class="itemTypeId" style="width: 90px;text-align: center;">毛孩玩具</td></c:if>
										<c:if test="${itemVO.itemTypeId == '3'}"><td scope="col" class="itemTypeId" style="width: 90px;text-align: center;">毛孩傢俱</td></c:if>
										<c:if test="${itemVO.itemTypeId == '4'}"><td scope="col" class="itemTypeId" style="width: 90px;text-align: center;">毛孩衣物</td></c:if>
										<c:if test="${itemVO.itemTypeId == '5'}"><td scope="col" class="itemTypeId" style="width: 90px;text-align: center;">毛孩清潔</td></c:if>
										<c:if test="${itemVO.itemTypeId == '6'}"><td scope="col" class="itemTypeId" style="width: 90px;text-align: center;">毛孩保養</td></c:if>
										...
										<c:if test="${itemVO.itemStatus == '0'}"><td scope="col" class="itemStatus" style="width: 91.5px;text-align: center;">待上架</td></c:if>
										<c:if test="${itemVO.itemStatus == '1'}"><td scope="col" class="itemStatus" style="width: 91.5px;text-align: center;">上架中</td></c:if>
										<c:if test="${itemVO.itemStatus == '2'}"><td scope="col" class="itemStatus" style="width: 91.5px;text-align: center;">已下架</td></c:if>
										<td style="width: 88px;text-align: center;">${itemVO.itemUpdate}</td>	
										<td>	
			...
			<div class="col-md-6"">
			   <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
			       <ul class="pagination">
			           ...
			           <li style="margin-right:30px;"><a class="page-link" href="#" aria-label="Next"><span aria-hidden="true">»</span></a></li>
			       </ul>
			   </nav>
			</div>
        </div> <!-- class="row"的結尾標籤-->
